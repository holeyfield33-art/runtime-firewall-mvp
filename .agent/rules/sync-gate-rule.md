...
These five files are the actual enforcement core — the hook installation point (`index.js`) and
the detection engine (`detector.js`, `behavior-tracker.js`, `aho-corasick.js`, `policy.js`). A
