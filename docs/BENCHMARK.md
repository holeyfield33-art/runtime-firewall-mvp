...
6. Machine-readable result schema (JSON)

Top-level object:

{
  "metadata": { /* environment provenance */ },
  "workload": { "name": "cold-900-module-flat", "modules": 900, "iterations": <N>, "repeatsPerIter": <R>, "warmupIters": <W> },
  "mode": "cold-process",
  ...
  "gate": { "medianBudget": <number>, "p95Budget": <number> }
}
